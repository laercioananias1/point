...
class MatriculaExcecao(TimestampMixin, Base):
    ...
    (aluno cancelando a própria aula, ou admin ajustando a agenda por ele)
    e created_at (TimestampMixin, a linha nunca é editada depois de criada,
    então created_at já é a data/hora do cancelamento)."""
